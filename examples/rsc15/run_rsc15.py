...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch', action="store", dest='hidden', default=1, type=int)
    parser.add_argument('--batch_size', action="store", dest='hidden', default=32, type=int)
    parser.add_argument('--learning_rate', action="store", dest='hidden', default=0.1, type=float)
    parser.add_argument('--n_sample', action="store", dest='hidden', default=2048, type=int)
    #parser.add_argument('--batch_size', action="store", dest='hidden', default=32, type=int)
